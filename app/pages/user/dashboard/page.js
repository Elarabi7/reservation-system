...
import CreateReservation from '../../../components/CreateReservation'; // Import the component
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-indigo-900 via-indigo-700 to-indigo-500 flex flex-col items-center justify-start font-inter py-8">
      <div className="text-center text-white mb-8">
        <h1 className="text-6xl font-extrabold tracking-tight drop-shadow-md">Welcome, {username}!</h1>
        <p className="text-xl mt-4">Here are your reservations:</p>
      </div>
        ...
        <table className="table-auto w-full text-white bg-white rounded-lg shadow-xl">
          ...
          <tbody className="text-black">
            {userReservations.length === 0 ? (
              <tr>
                <td colSpan="6" className="text-center py-6">No reservations found.</td>
              </tr>
            ) : (
      ...
      {/* Button to show the Create Reservation Modal */}
      <button
        onClick={toggleModal}
      ...
      {showModal && (
        ...
        >
          <div className="relative bg-white rounded-lg shadow-xl w-1/2 lg:w-1/3">
            {/* Close button (X) */}
            <button
              onClick={toggleModal}
